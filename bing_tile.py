...
class TileSystem:
    ...
    MapScale(self, latitude, levelOfDetail, screenDpi):
    ...
    LatLongToPixelXY(self, latitude, longitude,levelOfDetail):
        latitude = self.Clip(latitude, self.MinLatitude, self.MaxLatitude)
    ...
    PixelXYToLatLong(self, pixelX, pixelY, levelOfDetail):
        mapSize = self.MapSize(levelOfDetail)
    ...
    TileXYToQuadKey(self, tileX, tileY, levelOfDetail):
        quadKey = ''
